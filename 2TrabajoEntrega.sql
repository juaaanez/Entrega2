...
select precio from productos where precio>100;

create view deliverys as
select tipo from Delivery where tipo like 'a%';

create view tiposproductos as
select tipo from Productos where tipo like '%a';

create view nombresrestaurantes as
select NombreR from Restaurante;

create view pagos as 
select tipo_pago from Forma_De_Pago where tipo_pago like 'efe%';
